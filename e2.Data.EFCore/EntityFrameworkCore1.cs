...
//namespace Csla.Data.EntityFrameworkCore1
//{
//  /// <summary>
...
//        {
//            if(Configuration.ConfigurationManager.AppSettings["IsMultiCompanyService"]=="true")
//            {
//              if (!database.Equals("SDMDb") && !database.Equals("ALMDb"))
//              {
//                string CompanyID = (Csla.ApplicationContext.GlobalContext["_Company"]).ToString();
//                if (!string.IsNullOrEmpty(CompanyID))
//                {
//                  database = CompanyID + database;
//                }
//              }
//            }          
//        }
