...
namespace QuickGSTInvoice.Views
{
    ...
    public partial class SalesInvoiceView : ContentPage
    {
        ...
        #region Events
        Syncfusion.Drawing.RectangleF TotalPriceCellBounds = Syncfusion.Drawing.RectangleF.Empty;
        ...
        private void OnButtonClicked(object sender, EventArgs e)
        {
           ...
           // Assembly assembly = typeof(SalesInvoiceView).GetTypeInfo().Assembly;
            
            string basePath = "QuickGSTInvoice.QuickGSTInvoice.Resources.Fonts.";
            Assembly assembly = GetType().GetTypeInfo().Assembly;



            Stream? fontStream = assembly.GetManifestResourceStream("QuickGSTInvoice.Resources.Fonts.arial.ttf");
            ...
            graphics.DrawRectangle(borderPen, new Syncfusion.Drawing.RectangleF(0, 0, pageWidth, pageHeight));
          ...
          //  graphics.DrawString(title, logoFont, whiteBrush, new Syncfusion.Drawing.RectangleF(0, 0, textSize.Width + 50, 2), format);
           ...
           graphics.DrawRectangle(darkBlueBrush, headerTotalBounds);
            ...
            graphics.DrawString("Amount", arialRegularFont, whiteBrush, new Syncfusion.Drawing.RectangleF(400, 0, pageWidth - 400, headerHeight / 2 - arialRegularFont.Height), format);
            #endregion
            //Measure the string size using font. 
            ...
            Stream? imageStream = assembly1.GetManifestResourceStream("QuickGSTInvoice.Resources.Images.pn.png");

            //Stream? imageStream = assembly.GetManifestResourceStream(basePath1+"charts.svg");

            //Create PDF bitmap image from stream.
           // PdfBitmap bitmap = new(imageStream);
            //Draw the image to PDF page. 
          //  graphics.DrawImage(bitmap, new Syncfusion.Drawing.RectangleF(10, pageHeight - 90, 80, 80));
